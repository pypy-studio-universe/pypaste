...
| DEV-042 | 2026-08-15 | Provide an installer without ZIP extraction | Build a universal compressed DMG with PyPaste.app + Applications shortcut, verify it read-only, upload it to v0.1.0, and make DMG the primary documentation path | APPROVED |
