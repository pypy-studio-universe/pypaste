# PyPaste 0.1.0 — Development Preview

## Tiếng Việt

Đây là bản thử nghiệm đầu tiên của PyPaste dành cho macOS 14 trở lên. Bản này bao gồm lịch sử
clipboard, Quick Bar `⌘⇧V`, tìm kiếm gần đúng, collections, preview ảnh/màu/link, tự nhập ảnh
chụp màn hình, kéo thả, song ngữ Việt–Anh và tự động dán khi đã cấp Accessibility.
...
history, the `⌘⇧V` Quick Bar, fuzzy search, collections, image/color/link previews, automatic
screenshot import, drag and drop, Vietnamese–English localization, and automatic paste after
